package fishtank.qa.nuscale.utils;
...
//	****** GET CSS properties value  ******
	...
	public String getElemementColor(By locator) {

		String colorCode = getElement(locator).getCssValue("color");

		String hexacolor = Color.fromString(colorCode).asHex();

		//getElemementFontfamily(locator);

		//getElemementFontSize(locator);

		return hexacolor;
	}
	
	/* This method used to verify background color code */

	public String getElemementBackColor(By locator) {

		String colorCode = getElement(locator).getCssValue("background-color");
	...
	public String getElemementFontfamily(By locator) {

		String fFamily = getElement(locator).getCssValue("font-family");
	...
	public String getElemementFontSize(By locator) {

		String fSize = getElement(locator).getCssValue("font-size");

		return fSize;

	}
	
	/* This method used to verify image height */
	public String getElemementImgHeight(By locator) {

		String imgHeight = getElement(locator).getCssValue("height");

		return imgHeight;

	}
	
	/* This method used to verify image width */
	public String getElemementImgWidth(By locator) {

		String imgWidth = getElement(locator).getCssValue("width");
	...
	public String getElemementheight(By locator) {

		String height = getElement(locator).getCssValue("height");
	...
	public String getElemementPaddingBottom(By locator) {

		String imgWidth = getElement(locator).getCssValue("padding-bottom");

		return imgWidth;
	}
	
	/* This method used to verify opacity */
	public String getElemementOpacity(By locator) {

		String imgWidth = getElement(locator).getCssValue("opacity");
